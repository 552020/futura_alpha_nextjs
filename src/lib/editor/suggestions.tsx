...
import { Suggestion as PreviewSuggestion } from "@/components/chat-ai/suggestion";
import type { Suggestion } from "@/db/schema";
import type { ArtifactKind } from "@/components/chat-ai/artifact";
...
export function createSuggestionWidget(
  ...
  root.render(<PreviewSuggestion suggestion={suggestion} onApply={onApply} artifactKind={artifactKind} />);
