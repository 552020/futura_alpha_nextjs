  ...
  const faqItems = dict.faq?.items || [
    {
      ...
      answer:
        'This platform helps users create and manage their digital presence with powerful tools and features.',
    },
    {
      question: 'How do I create an account?',
      answer:
        'You can create an account by clicking the Sign In button and following the registration process.',
    },
    {
