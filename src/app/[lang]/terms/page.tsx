  ...
  return (
    <main className="container mx-auto px-6 py-12 max-w-3xl">
      ...
      <section className="space-y-4">
        <p>
          Welcome to Futura. By accessing or using our website, applications, or
        ...
        <p>
          ...
          and for keeping your credentials secure. Notify us immediately of any
          unauthorized use.
        </p>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            Do not infringe the rights of others, including privacy and
            intellectual property rights.
          </li>
          <li>
            Do not attempt to interfere with or disrupt the Service or its
            infrastructure.
          </li>
        </ul>
        ...
        <p>
          You retain ownership of content you upload or create. By providing
          content, you grant us a limited, non-exclusive, worldwide license to
          host and display it solely to operate the Service.
        </p>

        <h2 className="text-xl font-semibold mt-8">5. Third-Party Services</h2>
        <p>
          The Service may integrate with third-party providers. We are not
          responsible for the availability or performance of third-party
          services.
        </p>
        ...
        <p>
          ...
          when posted. Continued use of the Service after changes constitutes
