export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    authn_method_session_info: IDL.Func([IdentityNumber], [IDL.Opt(AuthnMethodSessionInfo)], ['query']),
    ...
    get_account_delegation: IDL.Func(
      [UserNumber, FrontendHostname, IDL.Opt(AccountNumber), SessionKey, Timestamp],
      [
        IDL.Variant({
          Ok: SignedDelegation,
    ...
    identity_registration_start: IDL.Func([], [IDL.Variant({ Ok: IdRegNextStepResult, Err: IdRegStartError })], []),
    init_salt: IDL.Func([], [], []),
    lookup: IDL.Func([UserNumber], [IDL.Vec(DeviceData)], ['query']),
    lookup_by_registration_mode_id: IDL.Func([RegistrationId], [IDL.Opt(IdentityNumber)], ['query']),
    ...
    prepare_account_delegation: IDL.Func(
      [UserNumber, FrontendHostname, IDL.Opt(AccountNumber), SessionKey, IDL.Opt(IDL.Nat64)],
      [
        IDL.Variant({
