export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    calculate_gallery_capsule_size: IDL.Func([Gallery], [IDL.Nat64], ['query']),
    calculate_gallery_size: IDL.Func([Gallery], [IDL.Nat64], ['query']),
    capsules_bind_neon: IDL.Func([ResourceType, IDL.Text, IDL.Bool], [Result], []),
    ...
    capsules_read_basic: IDL.Func([IDL.Opt(IDL.Text)], [Result_2], ['query']),
    ...
    create_personal_canister: IDL.Func([], [PersonalCanisterCreationResponse], []),
    debug_finish_hex: IDL.Func([IDL.Nat64, IDL.Text, IDL.Nat64], [Result_4], []),
    debug_put_chunk_b64: IDL.Func([IDL.Nat64, IDL.Nat32, IDL.Text], [Result], []),
    debug_sha256: IDL.Func([IDL.Vec(IDL.Nat8)], [IDL.Text], ['query']),
    galleries_create: IDL.Func([GalleryData], [Result_5], []),
    galleries_create_with_memories: IDL.Func([GalleryData, IDL.Bool], [Result_5], []),
    ...
    galleries_update: IDL.Func([IDL.Text, GalleryUpdateData], [Result_5], []),
    get_canister_size_stats: IDL.Func([], [CanisterSizeStats], ['query']),
    get_creation_states_by_status: IDL.Func([CreationStatus], [Result_6], ['query']),
    get_creation_status: IDL.Func([], [IDL.Opt(CreationStatusResponse)], ['query']),
    get_detailed_creation_status: IDL.Func([], [IDL.Opt(DetailedCreationStatus)], ['query']),
    get_detailed_migration_status: IDL.Func([], [IDL.Opt(DetailedCreationStatus)], ['query']),
    get_gallery_size_breakdown: IDL.Func([Gallery], [GallerySizeInfo], ['query']),
    get_gallery_size_info: IDL.Func([Gallery], [IDL.Text], ['query']),
    get_migration_states_by_status: IDL.Func([CreationStatus], [Result_6], ['query']),
    get_migration_stats: IDL.Func([], [Result_7], ['query']),
    get_migration_status: IDL.Func([], [IDL.Opt(CreationStatusResponse)], ['query']),
    get_my_personal_canister_id: IDL.Func([], [IDL.Opt(IDL.Principal)], ['query']),
    get_personal_canister_creation_stats: IDL.Func([], [Result_7], ['query']),
    get_personal_canister_id: IDL.Func([IDL.Principal], [IDL.Opt(IDL.Principal)], ['query']),
    get_user_creation_status: IDL.Func([IDL.Principal], [Result_8], ['query']),
    get_user_migration_status: IDL.Func([IDL.Principal], [Result_8], ['query']),
    greet: IDL.Func([IDL.Text], [IDL.Text], ['query']),
    is_migration_enabled: IDL.Func([], [Result_3], ['query']),
    is_personal_canister_creation_enabled: IDL.Func([], [Result_3], ['query']),
    ...
    memories_create: IDL.Func([IDL.Text, MemoryData, IDL.Text], [Result_4], []),
    ...
    memories_update: IDL.Func([IDL.Text, MemoryUpdateData], [MemoryOperationResponse], []),
    ...
    set_personal_canister_creation_enabled: IDL.Func([IDL.Bool], [Result], []),
    update_gallery_storage_location: IDL.Func([IDL.Text, GalleryStorageLocation], [Result], []),
    upload_config: IDL.Func([], [UploadConfig], ['query']),
    uploads_abort: IDL.Func([IDL.Nat64], [Result], []),
    uploads_begin: IDL.Func([IDL.Text, MemoryMeta, IDL.Nat32, IDL.Text], [Result_11], []),
    uploads_finish: IDL.Func([IDL.Nat64, IDL.Vec(IDL.Nat8), IDL.Nat64], [Result_4], []),
    uploads_put_chunk: IDL.Func([IDL.Nat64, IDL.Nat32, IDL.Vec(IDL.Nat8)], [Result], []),
