      ...
      >
        ...
        <div
          className={cn("flex flex-col", {
            ...
            "w-full":
              (message.role === "assistant" && message.parts?.some((p) => p.type === "text" && p.text?.trim())) ||
              mode === "edit",
        ...
        >
          ...
          {message.parts?.map((part, index) => {
                ...
                return (
                  <div key={key}>
                    <MessageContent
                      ...
                      className={cn({
                        "w-fit break-words rounded-2xl px-3 py-2 text-right text-white": message.role === "user",
                ...
                <Tool key={toolCallId} defaultOpen={true}>
                  ...
                  <ToolContent>
                    ...
                    {state === "output-available" && (
                      <ToolOutput output={<Weather weatherAtLocation={part.output} />} errorText={undefined} />
                    )}
                  </ToolContent>
                </Tool>
              );
            ...
            if (type === "tool-createDocument") {
              ...
              return <DocumentPreview key={toolCallId} isReadonly={isReadonly} result={part.output} />;
            }
