  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Enable developer and admin features for testing and system management.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
          ...
          <>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">
                  Enable testing features like bulk memory deletion and debug
                  tools.
                </p>
              </div>
              <Switch
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-sm text-muted-foreground">
            {isAdmin ? 'Enabled (Admin Role)' : 'Disabled'}
          </div>
        </div>
        {(devMode || isAdmin) && (
          <>
