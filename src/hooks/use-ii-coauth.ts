/**
 * II Co-Auth React Hook - COMMENTED OUT
 *
 * OLD HOOK BEING REPLACED BY useIILinks()
 * This file is temporarily commented out to test what breaks.
 */

// COMMENTED OUT - OLD HOOK BEING REPLACED BY useIILinks()
...
// These will be removed once components are migrated to useIILinks()
export function useIICoAuth() {
  throw new Error('useIICoAuth is deprecated. Use useIILinks() instead.');
}

export function useIICoAuthRequired() {
  throw new Error('useIICoAuthRequired is deprecated. Use useIILinksRequired() instead.');
}

export function useIIActivationFlow() {
  throw new Error('useIIActivationFlow is deprecated. Use useIILinksFlow() instead.');
}
