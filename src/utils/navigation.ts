import { Vault, Grid, Newspaper, Share2, User, Users, MessageCircle, LucideIcon } from 'lucide-react';
...
export type NavItem = {
  ...
  label: string;
  translationKey: 'dashboard' | 'gallery' | 'feed' | 'shared' | 'contacts' | 'profile' | 'icp' | 'chat';
};
...
export const mainNavItems: NavItem[] = [
  ...
  { href: '/chat', icon: MessageCircle, label: 'AI Chat', translationKey: 'chat' },
