 ...
 */
export const getGalleryRecord = async (galleryId: string): Promise<GalleryOperationResult<DBGallery>> => {
    try {
 ...
 */
export const getGalleriesByOwner = async (ownerId: string): Promise<GalleryOperationResult<DBGallery[]>> => {
 ...
 */
export const getSharedGalleries = async (allUserId: string): Promise<GalleryOperationResult<DBGallery[]>> => {
    try {
...
export const getAllAccessibleGalleries = async (
    ...
    try {
        ...
        // Combine and sort
        const allGalleries = [...(ownedResult.data || []), ...(sharedResult.data || [])];
 ...
 */
export const deleteGalleryRecord = async (galleryId: string): Promise<GalleryOperationResult> => {
    try {
        ...
        const [deletedGallery] = await db.delete(galleries).where(eq(galleries.id, galleryId)).returning();
...
export const createGalleryItems = async (
    ...
    try {
        const createdItems = await db.insert(galleryItems).values(items).returning();
 ...
 */
export const getGalleryItems = async (galleryId: string): Promise<GalleryOperationResult> => {
    try {
 ...
 */
export const shareGalleryWithUser = async (params: ShareGalleryParams): Promise<GalleryOperationResult> => {
    try {
 ...
 * Get gallery shares
 */
export const getGalleryShares = async (galleryId: string): Promise<GalleryOperationResult> => {
    try {
